...
export function SettlementPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([nextCycles, nextPreview, nextRule, nextWallets]) => {
        if (!active) return;
